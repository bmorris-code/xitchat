// Convert SVG to PNG icons for XitChat PWA
const fs = require('fs');
const path = require('path');

// Simple SVG content as base64 data URLs
...
<html>
<head>
    <title>XitChat Icon Generator</title>
    <style>
        ...
        canvas { border: 1px solid #00ff41; }
        button { background: #00ff41; color: #000; border: none; padding: 10px; margin: 5px; cursor: pointer; }
    </style>
</head>
<body>
    <h1>XitChat Icon Generator</h1>
...
fs.writeFileSync(path.join(__dirname, 'icon-generator.html'), htmlGenerator);
console.log('✅ Open icon-generator.html in your browser to download all PNG icons!');
console.log('📱 This will create all the required sizes for iPhone home screen icons.');
